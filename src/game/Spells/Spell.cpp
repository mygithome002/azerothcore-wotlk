...
uint32 Spell::GetCCDelay(SpellInfo const* _spell)
{
	...
	AuraType auraWithCCD[] = {SPELL_AURA_MOD_STUN, SPELL_AURA_MOD_CONFUSE, SPELL_AURA_MOD_FEAR, SPELL_AURA_MOD_SILENCE, SPELL_AURA_MOD_DISARM, SPELL_AURA_MOD_POSSESS};
